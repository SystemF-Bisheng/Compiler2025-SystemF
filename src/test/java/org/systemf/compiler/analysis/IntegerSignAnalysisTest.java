...
public class IntegerSignAnalysisTest {
	public static void main(String[] args) {
		...
		var result = query.getAttribute(module, IntegerSignAnalysisResult.class);
		module.dump(System.out);
		result.sign().forEach((v, sign) -> System.out.printf("%s: %s\n", ValueUtil.dumpIdentifier(v), sign));
	}
}
